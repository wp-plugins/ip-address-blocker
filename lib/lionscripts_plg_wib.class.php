...
if(!class_exists('lionscripts_plg_wib'))
{
	class lionscripts_plg_wib extends lionscripts_plg
	{
		...
		{
			global $wpdb;
			$sql = "CREATE TABLE ".$this->plg_table['ip']." (id int(12) NOT NULL AUTO_INCREMENT, ip VARCHAR(255) DEFAULT '' NOT NULL, UNIQUE KEY id (id));"; 
			...
			<div class="wrap">
				...
				<div class="content_left">
					<div id="lionscripts_plg_settings">
						...
						<b>Your current IP Address is </b><?php echo '123.123.123.123'//LIONSCRIPTS_CURRENT_USER_IP; ?> , <b><font title="You will be unable to view your site if you block your own IP Address.">Please do not block your own IP.</font></b>
