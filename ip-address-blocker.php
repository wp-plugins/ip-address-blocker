    ...
    <div class="wrap" style="margin-left:1%;">
    	...
    	<div style="width:70%;float:left;">
    		<div id="wib_settings">
                ...
                <br /><br />
                	<b>You current IP Address is </b><?php echo $_SERVER['REMOTE_ADDR']; ?> , <b><font title="You will be unable to view your site if you block your own IP Address.">Please do not block your own IP.</font></b>
                ...
                <p>
                    ...
                    <br /><br />
                    <small>For all kind of Inquiries and Support, please email us at <a href="mailto:<?php echo LIONSCRIPTS_WIB_BASIC_SUPPORT_EMAIL; ?>" target="_blank"><?php echo LIONSCRIPTS_WIB_BASIC_SUPPORT_EMAIL; ?></a>.</small>
                    <br /><br />
